...
func doNew(appName string) {
	...
	_, err := git.PlainClone("./"+appName, false, &git.CloneOptions{
		URL:      "https://github.com/SinjiPrasetio/SpeedlightApp.git",
		Progress: os.Stdout,
		Depth:    1,
	})
	...
	color.Yellow("\tCreating new env file.")
	...
	env = strings.ReplaceAll(env, "${KEY}", speed.RandomString(32))
	...
	// update existing .go file with correct name and imports
