...
func doMake(arg2, arg3 string) error {
	...
	case "migration":
		...
		upFile := speed.RootPath + "/migrations/" + fileName + "." + dbType + ".up.sql"
		downFile := speed.RootPath + "/migrations/" + fileName + "." + dbType + ".down.sql"
	...
	case "handler":
		...
		fileName := speed.RootPath + "/handlers/" + strings.ToLower(arg3) + ".go"
	...
	case "model":
		...
		fileName := speed.RootPath + "/data/" + strings.ToLower(modelName) + ".go"
		if fileExists(fileName) {
			exitGracefully(errors.New(fileName + " already exists"))
		}
	...
	case "mail":
		...
		htmlMail := speed.RootPath + "/mail/" + strings.ToLower(arg3) + ".html.tmpl"
		plainMail := speed.RootPath + "/mail/" + strings.ToLower(arg3) + ".plain.tmpl"
