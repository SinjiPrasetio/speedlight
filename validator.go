...
func (c *Speedlight) Validator(data url.Values) *Validation {
	return &Validation{
...
func (v *Validation) Required(r *http.Request, fields ...string) {
	for _, field := range fields {
		...
		if strings.TrimSpace(value) == "" {
			v.AddError(field, "This field can't be blank")
		}
	}
}
...
func (v *Validation) IsString(field, value string) {
	...
	if err != nil {
		v.AddError(field, "This field must be a date in YYYY-MM-DD format.")
	}
}
