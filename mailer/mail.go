...
func (m *Mail) ChooseApi(msg Message) error {
	...
	default:
		return fmt.Errorf("Unknow api %s; only mailgun, sparkpost,sendgrid accepted.", m.API)
	}
}
...
func (m *Mail) addApiAttachment(msg Message, tx *apimail.Transmission) error {
